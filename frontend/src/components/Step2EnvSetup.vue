      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('envSetup.simInstanceInit') }}</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 0" class="badge success">{{ t('status.completed') }}</span>
            <span v-else class="badge processing">{{ t('status.initialized') }}</span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <div v-if="simulationId" class="info-card">
            ...
            <div class="info-row">
              ...
              <span class="info-value mono">{{ taskId || t('envSetup.asyncTaskDone') }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('envSetup.genAgentProfile') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            <div class="stat-card">
              ...
              <span class="stat-label">{{ t('envSetup.currentAgents') }}</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ expectedTotal || '-' }}</span>
              <span class="stat-label">{{ t('envSetup.expectedAgents') }}</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ totalTopicsCount }}</span>
              <span class="stat-label">{{ t('envSetup.topicsCount') }}</span>
            </div>
          </div>
          ...
          <div v-if="profiles.length > 0" class="profiles-preview">
            <div class="preview-header">
              <span class="preview-title">{{ t('envSetup.generatedProfiles') }}</span>
            </div>
            <div class="profiles-list">
              ...
              >
                ...
                <div class="profile-meta">
                  <span class="profile-profession">{{ profile.profession || t('envSetup.unknownProfession') }}</span>
                </div>
                <p class="profile-bio">{{ profile.bio || t('envSetup.noBio') }}</p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('envSetup.genDualConfig') }}</span>
          </div>
          <div class="step-status">
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                <div class="config-item">
                  <span class="config-item-label">{{ t('envSetup.simDuration') }}</span>
                  <span class="config-item-value">{{ simulationConfig.time_config?.total_simulation_hours || '-' }} {{ t('envSetup.hours') }}</span>
                </div>
                <div class="config-item">
                  <span class="config-item-label">{{ t('envSetup.roundDuration') }}</span>
                  <span class="config-item-value">{{ simulationConfig.time_config?.minutes_per_round || '-' }} {{ t('envSetup.minutes') }}</span>
                </div>
                <div class="config-item">
                  <span class="config-item-label">{{ t('envSetup.totalRounds') }}</span>
                  <span class="config-item-value">{{ Math.floor((simulationConfig.time_config?.total_simulation_hours * 60 / simulationConfig.time_config?.minutes_per_round)) || '-' }} {{ t('envSetup.rounds') }}</span>
                </div>
                <div class="config-item">
                  <span class="config-item-label">{{ t('envSetup.activePerHour') }}</span>
                  <span class="config-item-value">{{ simulationConfig.time_config?.agents_per_hour_min }}-{{ simulationConfig.time_config?.agents_per_hour_max }}</span>
                </div>
              </div>
              <div class="time-periods">
                <div class="period-item">
                  <span class="period-label">{{ t('envSetup.peakHours') }}</span>
                  <span class="period-hours">{{ simulationConfig.time_config?.peak_hours?.join(':00, ') }}:00</span>
                  <span class="period-multiplier">×{{ simulationConfig.time_config?.peak_activity_multiplier }}</span>
                </div>
                <div class="period-item">
                  <span class="period-label">{{ t('envSetup.workHours') }}</span>
                  <span class="period-hours">{{ simulationConfig.time_config?.work_hours?.[0] }}:00-{{ simulationConfig.time_config?.work_hours?.slice(-1)[0] }}:00</span>
                  <span class="period-multiplier">×{{ simulationConfig.time_config?.work_activity_multiplier }}</span>
                </div>
                <div class="period-item">
                  <span class="period-label">{{ t('envSetup.morningHours') }}</span>
                  <span class="period-hours">{{ simulationConfig.time_config?.morning_hours?.[0] }}:00-{{ simulationConfig.time_config?.morning_hours?.slice(-1)[0] }}:00</span>
                  <span class="period-multiplier">×{{ simulationConfig.time_config?.morning_activity_multiplier }}</span>
                </div>
                <div class="period-item">
                  <span class="period-label">{{ t('envSetup.offPeakHours') }}</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">{{ t('envSetup.agentConfig') }}</span>
                <span class="config-block-badge">{{ simulationConfig.agent_configs?.length || 0 }} {{ t('envSetup.countUnit') }}</span>
              </div>
              <div class="agents-cards">
                ...
                >
                  ...
                  <div class="agent-timeline">
                    <span class="timeline-label">{{ t('envSetup.activeHours') }}</span>
                  ...
                  <div class="agent-params">
                    <div class="param-group">
                      <div class="param-item">
                        <span class="param-label">{{ t('envSetup.postsPerHour') }}</span>
                        <span class="param-value">{{ agent.posts_per_hour }}</span>
                      </div>
                      <div class="param-item">
                        <span class="param-label">{{ t('envSetup.commentsPerHour') }}</span>
                        <span class="param-value">{{ agent.comments_per_hour }}</span>
                      </div>
                      <div class="param-item">
                        <span class="param-label">{{ t('envSetup.responseDelay') }}</span>
                        <span class="param-value">{{ agent.response_delay_min }}-{{ agent.response_delay_max }}min</span>
                      </div>
                    </div>
                    <div class="param-group">
                      <div class="param-item">
                        <span class="param-label">{{ t('envSetup.activityLevel') }}</span>
                      ...
                      <div class="param-item">
                        <span class="param-label">{{ t('envSetup.sentimentBias') }}</span>
                        <span class="param-value" :class="agent.sentiment_bias > 0 ? 'positive' : agent.sentiment_bias < 0 ? 'negative' : 'neutral'">
                          {{ agent.sentiment_bias > 0 ? '+' : '' }}{{ agent.sentiment_bias?.toFixed(1) }}
                        </span>
                      </div>
                      <div class="param-item">
                        <span class="param-label">{{ t('envSetup.influenceWeight') }}</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">{{ t('envSetup.recoAlgoConfig') }}</span>
              </div>
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">{{ t('envSetup.platform1Name') }}</span>
                  </div>
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">{{ t('envSetup.recencyWeight') }}</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.recency_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">{{ t('envSetup.popularityWeight') }}</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.popularity_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">{{ t('envSetup.relevanceWeight') }}</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.relevance_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">{{ t('envSetup.viralThreshold') }}</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.viral_threshold }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">{{ t('envSetup.echoChamberStrength') }}</span>
                ...
                <div v-if="simulationConfig.reddit_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">{{ t('envSetup.platform2Name') }}</span>
                  </div>
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">{{ t('envSetup.recencyWeight') }}</span>
            ...
            <div v-if="simulationConfig.generation_reasoning" class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">{{ t('envSetup.llmReasoning') }}</span>
              </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('envSetup.initialOrchestration') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <div v-if="simulationConfig?.event_config" class="orchestration-content">
            ...
            <div class="topics-section">
              <span class="box-label">{{ t('envSetup.initialHotTopics') }}</span>
            ...
            <div class="initial-posts-section">
              <span class="box-label">{{ t('envSetup.initialActivation') }} ({{ simulationConfig.event_config.initial_posts.length }})</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('envSetup.prepComplete') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">{{ t('envSetup.prepCompleteDesc') }}</p>
          
          <!-- 模拟轮数配置 - 只有在配置生成完成且轮数计算出来后才显示 -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">{{ t('envSetup.roundsConfig') }}</span>
                <span class="section-desc" v-html="roundsConfigDescHtml"></span>
              </div>
              <label class="switch-control">
                <input type="checkbox" v-model="useCustomRounds">
                <span class="switch-track"></span>
                <span class="switch-label">{{ t('envSetup.customMode') }}</span>
              </label>
            </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  <div class="slider-main-value">
                    ...
                    <span class="val-unit">{{ t('envSetup.rounds') }}</span>
                  </div>
                  <div class="slider-meta-info">
                    <span>{{ t('envSetup.estimatedTime', { minutes: Math.round(customMaxRounds * 0.6) }) }}</span>
                  </div>
                </div>
                ...
                <div class="range-wrapper">
                  ...
                  <div class="range-marks">
                    ...
                    >40 ({{ t('envSetup.recommended') }})</span>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        {{ t('envSetup.estimatedTimeAuto', { minutes: Math.round(autoGeneratedRounds * 0.6) }) }}
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">{{ t('envSetup.firstRunTip') }}</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">{{ t('envSetup.apparentAge') }}</span>
              <span class="info-value">{{ selectedProfile.age || '-' }} {{ t('envSetup.ageUnit') }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">{{ t('envSetup.apparentGender') }}</span>
              <span class="info-value">{{ { male: t('envSetup.male'), female: t('envSetup.female'), other: t('envSetup.other') }[selectedProfile.gender] || selectedProfile.gender }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">{{ t('envSetup.countryRegion') }}</span>
              <span class="info-value">{{ selectedProfile.country || '-' }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">{{ t('envSetup.apparentMBTI') }}</span>
          ...
          <div class="modal-section">
            <span class="section-label">{{ t('envSetup.profileBio') }}</span>
            <p class="section-bio">{{ selectedProfile.bio || t('envSetup.noBio') }}</p>
          </div>

          <!-- 关注话题 -->
          <div class="modal-section" v-if="selectedProfile.interested_topics?.length">
            <span class="section-label">{{ t('envSetup.relatedTopics') }}</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            <span class="section-label">{{ t('envSetup.detailedPersona') }}</span>
            
            <!-- 人设维度概览 -->
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">{{ t('envSetup.fullExperience') }}</span>
                <span class="dim-desc">{{ t('envSetup.fullExperienceDesc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ t('envSetup.behaviorProfile') }}</span>
                <span class="dim-desc">{{ t('envSetup.behaviorProfileDesc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ t('envSetup.uniqueMemory') }}</span>
                <span class="dim-desc">{{ t('envSetup.uniqueMemoryDesc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ t('envSetup.socialNetwork') }}</span>
                <span class="dim-desc">{{ t('envSetup.socialNetworkDesc') }}</span>
              </div>
            </div>
...
const roundsConfigDescHtml = computed(() => {
  const hours = simulationConfig.value?.time_config?.total_simulation_hours || '-'
  const minutes = simulationConfig.value?.time_config?.minutes_per_round || '-'
  return t('envSetup.roundsConfigDesc', { hours: `<span class='desc-highlight'>${hours}</span>`, minutes: `<span class='desc-highlight'>${minutes}</span>` })
})
